...
$(document).ready( 
    function(){
        ...
        $('#btn_inciar_jogo').click(function(){
            ...
            //captura a validação dos apelidos dos jogadores
        ...
        function jogada(id){
            ...
            function ganhador(pontos){
                if(pontos == -3){
                    ...
                    alert( jogada_1 +' ganhou a partida')
                    $('.jogada').off()
                }
                else if(pontos == 3){
                    var jogada_2 = $('#entrada_apelido_jogador_2').val()
                    alert(jogada_2 + ' ganhou a partida')
                    $('.jogada').off()
                }
            }
});